define(function defineDemoFocusableWebkitNightly(require) {
  ...
  return {
    "platform": {
      "description": "WebKit Nightly 601.1.9 (like Safari 7+) on OS X 10.8.5",
      "layout": "WebKit",
      "manufacturer": null,
      "name": "WebKit Nightly",
      "prerelease": "alpha",
      "product": null,
      "ua": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/601.1.9+ (KHTML, like Gecko) Version/6.2 Safari/537.85.10",
      "version": "601.1.9",
      "os": {
        "architecture": 32,
        "family": "OS X",
