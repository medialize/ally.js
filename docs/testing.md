...
The test infrastructure is located in the `test` directory. Note that the `tests` directory is occupied by manual browser support tests <del>because I'm an idiot</del><ins>for historical reasons</ins>.
