/*jshint unused:vars */
define(function defineFocusSource(require) {
  'use strict';
  ...
  */
  ...
  var engageInteractionTypeListener = require('../event/interaction-type-listener');
  ...
  function engageFocusSourceListener() {
    if (!_engaged) {
  ...
  return engageFocusSourceListener;
