define(function defineDemoFocusableChromeCanary(require) {
  ...
  return {
    "platform": {
      "description": "Chrome 46.0.2478.0 on OS X 10.10.4",
      "layout": "Blink",
      "manufacturer": null,
      "name": "Chrome",
      "prerelease": null,
      "product": null,
      "ua": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2478.0 Safari/537.36",
      "version": "46.0.2478.0",
      "os": {
        "architecture": 32,
        "family": "OS X",
